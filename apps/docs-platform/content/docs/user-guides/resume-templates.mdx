...
| :--------------------- | :--------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------- |
| **Compact ATS**        | [web.tsx](https://github.com/VeriWorkly/veriworkly/blob/master/apps/studio/templates/compact-ats/web.tsx)        | [pdf.tsx](https://github.com/VeriWorkly/veriworkly/blob/master/apps/studio/templates/compact-ats/pdf.tsx)        |
| **Clean Professional** | [web.tsx](https://github.com/VeriWorkly/veriworkly/blob/master/apps/studio/templates/clean-professional/web.tsx) | [pdf.tsx](https://github.com/VeriWorkly/veriworkly/blob/master/apps/studio/templates/clean-professional/pdf.tsx) |
