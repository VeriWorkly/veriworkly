...
You can also explore the [Template Registry](https://github.com/VeriWorkly/veriworkly/blob/master/apps/studio/templates/index.ts) to see how these engines are integrated into the Studio.
