...
For the complete list of models including Roadmap and GitHub Sync entities, refer to the [full schema file](https://github.com/VeriWorkly/veriworkly/blob/master/apps/server/prisma/schema.prisma).
