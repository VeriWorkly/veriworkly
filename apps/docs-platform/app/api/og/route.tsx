...
export async function GET(request: Request) {
  try {
    ...
    const title = searchParams.get("title") ?? "VeriWorkly Docs";
    ...
    const baseUrl = process.env.SITE_URL ?? "https://docs.veriworkly.com";
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <span style={{ fontFamily: "monospace", fontWeight: 700 }}>VeriWorkly Docs</span>
          </div>
