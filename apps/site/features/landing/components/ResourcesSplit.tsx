      ...
      <div className="grid grid-cols-1 gap-24 lg:grid-cols-2 lg:gap-16">
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="font-sans text-3xl font-medium tracking-tighter text-balance text-white md:text-5xl">
        ...
        <div className="flex flex-col justify-center">
          <motion.h2
            className="font-sans text-4xl font-medium tracking-tighter text-balance text-zinc-950 md:text-5xl dark:text-white"
          ...
          >
            VeriWorkly is open-core. Read our comprehensive documentation to understand our privacy
            architecture, or learn how to self-host your own career workspace.
          </motion.p>
          ...
          >
            ...
            >
              <span className="border-b border-zinc-300 pb-1 dark:border-zinc-700">
                Explore the Docs
              </span>
