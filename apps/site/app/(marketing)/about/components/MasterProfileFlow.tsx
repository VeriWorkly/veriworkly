...
export function MasterProfileFlow() {
  return (
    <div className="relative overflow-hidden rounded-4xl border border-zinc-800 bg-[#0a0a0a] p-8 md:p-12">
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(120,119,198,0.06)_1px,transparent_1px),linear-gradient(to_bottom,rgba(120,119,198,0.06)_1px,transparent_1px)] bg-size-[26px_26px] mask-[radial-gradient(ellipse_70%_70%_at_30%_50%,#000_60%,transparent_100%)]" />
