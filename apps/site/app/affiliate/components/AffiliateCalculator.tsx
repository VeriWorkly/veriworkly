...
export function AffiliateCalculator() {
  ...
  // Prices from pricing.md
  // Creator Pro: $9.99/mo, Job Hunter Bundle: $14.99/mo
  ...
  return (
    ...
    >
      <div className="grid items-center gap-16 lg:grid-cols-2">
        {/* Left Side: Massive Live Value Display */}
        ...
        {/* Right Side: Interactive Sliders & Widgets */}
