...
const ComparisonTable = () => {
  ...
  return (
    <section className="bg-ink text-paper relative py-24 lg:py-32">
      ...
      <div className="relative z-10 mx-auto w-[min(1160px,calc(100%-32px))]">
        <div className="grid items-end gap-8 lg:grid-cols-[1fr_.65fr]">
          ...
          <p className="text-paper/70 border-t border-white/20 pt-5 text-base leading-7">
        ...
        >
          <div className="min-w-[760px]">
            <div
              className="text-paper/85 grid grid-cols-[minmax(250px,1fr)_repeat(4,130px)] bg-white/10 px-6 py-5 text-xs font-bold tracking-[0.15em] uppercase"
              role="row"
            >
            ...
            {comparisonRows.map(([label, ...values]) => (
              ...
              >
                <span className="text-paper/90 font-medium" role="cell">
                  {label}
                </span>
