  ...
  return (
    ...
    >
      <div>
        ...
        <h1 className="mt-7 max-w-6xl text-[clamp(3.8rem,8vw,7.5rem)] leading-[0.88] font-bold tracking-[-0.08em] wrap-normal">
      ...
      <div className="border-ink-2 border-t-2 pt-6">
        ...
        <div className="mt-5 flex flex-wrap gap-2">
          {template.strengths.map((strength) => (
            <span
              className="border-ink-2/15 rounded-full border bg-white px-3 py-1.5 text-xs font-bold"
              key={strength}
            >
              {strength}
            </span>
