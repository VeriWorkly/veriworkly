  ...
  return (
    <section className={`${templatesShell} grid gap-8 pb-20 lg:grid-cols-[minmax(0,1fr)_22rem]`}>
      ...
      <aside className="space-y-4 lg:sticky lg:top-8 lg:self-start">
        <div className="border-ink-2 rounded-3xl border-2 bg-white p-6 shadow-[10px_12px_0_rgba(37,99,235,0.14)]">
        ...
        <a
          className="bg-ink-2 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-full px-6 text-sm font-bold text-white transition duration-300 hover:-translate-y-1"
