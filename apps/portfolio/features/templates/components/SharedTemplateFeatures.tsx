...
const sharedFeaturesList: SharedFeature[] = [
  {
    ...
    description:
      "Write your case studies, biography, and credentials once. Keep 100% of your career data intact when changing styles.",
  },

  {
    title: "Instant Live Previews",
    description:
      "Compare structural layouts with a live-rendered preview using your real personal data before switching.",
  },

  {
    title: "Responsive by Design",
    description:
      "Every template features fluid grids and pure semantic HTML that render flawlessly across desktop and mobile screens.",
  },

  {
    title: "SEO & Crawler Optimization",
    description:
      "Built-in structured schemas, clean headings, customizable meta tags, and open graph cards for search engine rankings.",
  },

  {
    title: "VeriWorkly Subdomains",
    description:
      "Publish your portfolio in seconds to a professional, secure SSL-certified 'yourname.veriworkly.com' address.",
  },

  {
    title: "Private Draft Workflow",
    description:
      "Edit your changes in a private workspace environment and sync them to your public live site only when you are ready.",
  },
];

const SharedTemplateFeatures = () => {
  return (
    <section className="dark:bg-paper-2 relative overflow-hidden bg-[#11110f] py-24 text-[#f5f4ef] md:py-32">
      ...
      <div
        className={`${templatesShell} relative z-10 grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16`}
      >
        <div>
          ...
          <p className="mt-6 max-w-md text-sm leading-6 text-[#f5f4ef]/60">
            All VeriWorkly portfolio templates share a unified data engine. You can customize layout
            styles, subdomains, and SEO metadata while preserving 100% of your career data, case
            studies, and bio across layout switches without coding.
          </p>
        </div>
          ...
          {sharedFeaturesList.map(({ title, description }) => (
            ...
            >
              <div>
                ...
                <p className="mt-3.5 text-xs leading-5 font-normal text-[#f5f4ef]/70">
                  {description}
                </p>
              </div>
            </li>
