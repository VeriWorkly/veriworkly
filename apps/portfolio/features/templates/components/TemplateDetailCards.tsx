...
function DetailCard({
  ...
  return (
    <article className="border-ink-2/15 bg-panel rounded-3xl border p-6">
      {icon}
...
const TemplateDetailCards = ({ details }: { details: TemplateDetails }) => {
  return (
...
export default TemplateDetailCards;
